return {
    ...
    opts = {
        severity = { min = vim.diagnostic.severity.INFO }, -- | vim.diagnostic.severity.WARN | vim.diagnostic.severity.HINT, -- nil (ALL) or vim.diagnostic.severity.ERROR | WARN | INFO | HINT WARN | INFO | HINT, -- nil (ALL) or vim.diagnostic.severity.ERROR | WARN | INFO | HINT
